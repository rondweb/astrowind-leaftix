...
import 'piccolore';
import { m as maybeRenderHead, r as renderComponent, u as unescapeHTML, F as Fragment, a as renderTemplate } from './prerender_Cc-hlpSz.mjs';
import { c as $$Icon, $ as $$PageLayout } from './PageLayout_DvEhEmFQ.mjs';
import { $ as $$Hero } from './Hero_CW_28F0u.mjs';
import { $ as $$Features } from './Features_DeLwM6gq.mjs';
import { $ as $$Features2 } from './Features2_bScNVMC2.mjs';
import { $ as $$Steps } from './Steps_DNBp0V7a.mjs';
import { $ as $$Content } from './Content_CWNJT3Vb.mjs';
import { $ as $$BlogLatestPosts } from './BlogLatestPosts_CiS5ekpo.mjs';
import { $ as $$FAQs } from './FAQs_C08ikst2.mjs';
import { $ as $$Stats } from './Stats_BepGwGGi.mjs';
...
}, "E:/OTHER_PROJECTS/astrowind-leaftix/src/components/widgets/Note.astro", void 0);
...
const $$Index = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "Layout", $$PageLayout, { "metadata": metadata }, { "default": async ($$result2) => renderTemplate`  ${renderComponent($$result2, "Hero", $$Hero, { "actions": [
    {
      variant: "primary",
      text: "Get template",
  ...
  ], "image": { src: "~/assets/images/hero-image.png", alt: "AstroWind Hero Image" } }, { "subtitle": async ($$result3) => renderTemplate`${renderComponent($$result3, "Fragment", Fragment, { "slot": "subtitle" }, { "default": async ($$result4) => renderTemplate` ${maybeRenderHead()}<span class="hidden sm:inline"> <span class="font-semibold">AstroWind</span> is a free, customizable and production-ready template for Astro 5.0
...
Free template for <span class="hidden xl:inline">creating websites with</span> <span class="text-accent dark:text-white"> Astro 5.0</span> + Tailwind CSS
` })}` })}  ${renderComponent($$result2, "Note", $$Note, { "title": "Philosophy:", "description": "Simplicity, Best Practices and High Performance" })}  ${renderComponent($$result2, "Features", $$Features, { "id": "features", "tagline": "Features", "title": "What you get with AstroWind", "subtitle": "One of the most professional and comprehensive templates currently on the market. Most starred & forked Astro theme in 2022, 2023 and 2024.", "items": [
    {
    ...
    alt: "Colorful Image"
  } }, { "bg": async ($$result3) => renderTemplate`${renderComponent($$result3, "Fragment", Fragment, { "slot": "bg" }, { "default": async ($$result4) => renderTemplate` <div class="absolute inset-0 bg-blue-50 dark:bg-transparent"></div> ` })}`, "content": async ($$result3) => renderTemplate`${renderComponent($$result3, "Fragment", Fragment, { "slot": "content" }, { "default": async ($$result4) => renderTemplate` <h3 class="text-2xl font-bold tracking-tight dark:text-white sm:text-3xl mb-2">Building on modern foundations</h3>
...
` })}` })}  ${renderComponent($$result2, "Content", $$Content, { "isAfterContent": true, "items": [
    ...
    alt: "Blueprint Image"
  } }, { "bg": async ($$result3) => renderTemplate`${renderComponent($$result3, "Fragment", Fragment, { "slot": "bg" }, { "default": async ($$result4) => renderTemplate` <div class="absolute inset-0 bg-blue-50 dark:bg-transparent"></div> ` })}`, "content": async ($$result3) => renderTemplate`${renderComponent($$result3, "Fragment", Fragment, { "slot": "content" }, { "default": async ($$result4) => renderTemplate`Ensure your online presence truly represents you.` })}` })}  ${renderComponent($$result2, "Content", $$Content, { "isReversed": true, "isAfterContent": true, "items": [
    {
  ...
  } }, { "bg": async ($$result3) => renderTemplate`${renderComponent($$result3, "Fragment", Fragment, { "slot": "bg" }, { "default": async ($$result4) => renderTemplate` <div class="absolute inset-0 bg-blue-50 dark:bg-transparent"></div> ` })}`, "content": async ($$result3) => renderTemplate`${renderComponent($$result3, "Fragment", Fragment, { "slot": "content" }, { "default": async ($$result4) => renderTemplate`Designed to foster growth and success.` })}` })}  ${renderComponent($$result2, "Steps", $$Steps, { "title": "Get your dream website up and running in no time with AstroWind.", "items": [
    {
  ...
  ] }, { "subtitle": async ($$result3) => renderTemplate`${renderComponent($$result3, "Fragment", Fragment, { "slot": "subtitle" }, { "default": async ($$result4) => renderTemplate`
Be very surprised by these huge fake numbers you are seeing on this page. <br class="hidden md:inline">Don't
      waste more time! :P
` })}`, "title": async ($$result3) => renderTemplate`${renderComponent($$result3, "Fragment", Fragment, { "slot": "title" }, { "default": async ($$result4) => renderTemplate`
Astro&nbsp;+&nbsp;<br class="block sm:hidden"><span class="sm:whitespace-nowrap">Tailwind CSS</span> ` })}` })} ` })}`;
}, "E:/OTHER_PROJECTS/astrowind-leaftix/src/pages/index.astro", void 0);

const $$file = "E:/OTHER_PROJECTS/astrowind-leaftix/src/pages/index.astro";
const $$url = "";
