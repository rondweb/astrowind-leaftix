...
import { $ as $$Pricing$1 } from './Pricing_CdRqzPJN.mjs';
...
}, "E:/OTHER_PROJECTS/astrowind-leaftix/src/pages/pricing.astro", void 0);

const $$file = "E:/OTHER_PROJECTS/astrowind-leaftix/src/pages/pricing.astro";
const $$url = "/pricing";
